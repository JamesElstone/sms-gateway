...
REQUIRED_PACKAGES="${REQUIRED_PACKAGES:-apache24 php84 php84-curl php84-dom php84-mbstring php84-pdo php84-pdo_sqlite php84-simplexml php84-sqlite3 php84-xml mod_php84 sqlite3 usb_modeswitch}"
